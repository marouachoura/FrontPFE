...
export class SiteService {
 ...
 // test webhooks
  ...
  getSiteById(id: string): Promise<Sites> {
    return this.httpClient.get<Sites>('http://10.66.13.85:32000/api/test/sites/find/' + id).toPromise();
  
  }

  RemoveSiteById(id: string): Promise<void> {
    return this.httpClient.delete<void>('http://10.66.13.85:32000/api/test/sites/delete/' + id).toPromise();
  ...
  EditSite(id: any, site: Sites): Promise<Sites> {
    return this.httpClient.put<Sites>('http://10.66.13.85:32000/api/test/' + id, site).toPromise();
